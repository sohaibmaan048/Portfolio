...
After spending several weeks learning variables, conditions, loops, and debugging techniques, I finally reached a stage where I could apply those concepts to a complete project. Until this point, most of my programming experience consisted of small exercises and lab tasks. While those activities helped me understand individual concepts, I wanted to see how everything worked together in a larger program.

That opportunity came when I started working on my first ATM simulation project in Python. Looking back now, this project was a major milestone in my Programming Fundamentals journey because it was the first time I built something that resembled a real world application.

At first, the idea of creating an ATM system seemed intimidating. When I thought about the machines we use in banks, they appeared complex and sophisticated. I wondered how I would be able to recreate even a simple version using the programming knowledge I had acquired so far.

The project requirements were straightforward. The ATM system needed to allow users to perform basic operations such as checking their balance, depositing money, withdrawing money, and exiting the system. Although these features sounded simple individually, combining them into a single program required careful planning.
...
The next challenge was creating the deposit functionality. The logic seemed straightforward: accept an amount from the user and add it to the existing balance. However, I soon encountered problems related to user input and data handling. Sometimes the program accepted incorrect values, while other times calculations produced unexpected results.
...
These issues were frustrating, but they also reinforced the debugging skills I had developed earlier. Instead of becoming discouraged, I learned to approach problems systematically. I tested individual components, reviewed my logic carefully, and used print statements to monitor variable values.
...
This experience changed the way I viewed programming projects. Previously, I saw assignments as academic requirements. The ATM project showed me that programming can be used to create systems that solve practical problems. Even though the project was relatively simple, it provided a glimpse into how real software applications are developed.
...
For students who are beginning their own programming journey, I strongly recommend building small projects as early as possible. Projects reveal gaps in understanding, encourage creativity, and provide valuable hands on experience. Most importantly, they transform abstract concepts into practical skills.

Completing the ATM system gave me confidence in my programming abilities, but it also made me realize that learning Python was about much more than writing code. The real value of Programming Fundamentals was the way it changed how I approached problems and developed logical thinking skills.

That realization became the focus of my next reflection. After completing my first major project, I started looking back on the entire course and considering how Programming Fundamentals had influenced my growth as a Computer Engineering student.

---

## Reflection

The ATM simulation project was my first experience building a complete application from scratch. It combined everything I had learned during Programming Fundamentals and showed me how programming concepts work together to solve practical problems.

More importantly, the project taught me persistence, planning, debugging, and logical thinking. These lessons extended beyond Python and became valuable skills for future academic and technical challenges.

The experience proved that programming is not simply about learning syntax. It is about understanding problems, designing solutions, and continuously improving through practice and experience.
